...
あなたは、OpenIDを使用せずにログインできません。',
	'openiddelete-sucess' => 'あなたのアカウントから OpenID を除去しました。',
...
თქვენ შეგიძლიათ აირჩიოთ ქვემოთ მოცემულიდან ერთ-ერთი.',
	...
	'openiddelete-sucess' => 'OpenID წარმატებით წაიშალა თქვენი ანგარიშიდან.',
	...
	'openid-pref-hide' => 'თქვენი მომხმარებლის გვერდზე OpenID-ის URL-ის დამალვა, თუ თქვენ შეხვედით OpenID-ის საშუალებით.',
	'openid-pref-update-userinfo-on-login' => 'შემდეგი ინფორმაციის განახლება ჩემ შესახებ OpenID-ით ყოველ ჯერზე, როდესაც შევალ სისტემაში:',
	'openid-urls-desc' => 'თქვენ ანგარიშთან დაკავშირებული OpenID-ები:',
...
OpenID 없이 로그인 할 수 없습니다.',
	...
	'openid-login-or-create-account' => '로그인 또는 새 계정 만들기',
	...
	'right-openid-converter-access' => '추가하거나 계정을 OpenID 식별자를 사용하여 변환할 수 있습니다',
...
Будь-ласка, зверніться до [[Special:ListUsers/sysop|адміністратору сайту]].',
	...
	'openidsuccesstext' => 'Перевірка адреси OpenID пройшла успішно.', # Fuzzy
	'openidusernameprefix' => 'Користувач OpenID',
	'openidserverlogininstructions' => 'Введіть нижче ваш пароль, щоб увійти на $3 як користувач $2 (особиста сторінка $1).', # Fuzzy
...
Якщо ви бажаєте використовувати в майбутньому вхід через OpenID, ви можете [[Special:OpenIDConvert|перетворити ваш акаунт для використання в OpenID]].", # Fuzzy
...
Існує безліч [http://wiki.openid.net/Public_OpenID_providers загальнодоступних провайдерів OpenID], можливо, Ви вже маєте обліковий запис OpenID на іншому сайті.", # Fuzzy
